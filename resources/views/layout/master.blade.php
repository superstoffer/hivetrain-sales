...
<head>
    ...
    <title>Hivetrain.com - Distributed Portfolio Management</title>
        ...
        <div class="cover-container">
            <div class="masthead clearfix youtube">
                ...
                <div id="mc_embed_signup">
                    <form action="//hivetrain.us13.list-manage.com/subscribe/post?u=d562ac256c1aa484a8b31e4b4&amp;id=31fc717ba0" method="post" id="mc-embedded-subscribe-form" name="mc-embedded-subscribe-form" class="validate" target="_blank" novalidate>
                        <div id="mc_embed_signup_scroll">
                            ...
                            <div style="position: absolute; left: -5000px;" aria-hidden="true"><input type="text" name="b_d562ac256c1aa484a8b31e4b4_31fc717ba0" tabindex="-1" value=""></div>
                ...
                <div class="inner cover">
                    <p class="lead">Trade together with the crowd and get rewarded according to your skills</p>
                </div>
                <div class="row">
                    <div class="col-md-6">
                        <h4>As an investment newbie you will benefit from the experts</h4>
                    </div>
                    <div class="col-md-6">
                        <h4>As an experienced investor you will manage other people's portfolios</h4>
                    </div>
                </div>
                <br>
            </div>
